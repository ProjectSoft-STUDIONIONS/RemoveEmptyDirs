...
| --- | --- | --- | --- |
| ${evoname} Evolution CMS | ${author} | 2024-02-04  | ${today} |
`;
...
fs.writeFileSync(path.normalize(path.join(__dirname, 'install', 'assets', 'plugins', 'RemoveEmptyDirs.tpl')), tpl, {encoding: 'utf8'});
